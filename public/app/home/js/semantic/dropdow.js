...
$.fn.dropdow = function(parameters) {
  var
    $allModules    = $(this),
    $document      = $(document),
    ...
    .each(function() {
      var
        settings          = ( $.isPlainObject(parameters) )
          ? $.extend(true, {}, $.fn.dropdow.settings, parameters)
          : $.extend({}, $.fn.dropdow.settings),
      ...
      module = {
          ...
          select: function() {
            ...
            if($input.parent(selector.dropdow).length > 0) {
              ...
              $module = $('<div />')
                ...
                .addClass(className.dropdow)
                .html( settings.templates.dropdow(selectValues) )
                .insertBefore($input)
              ;
              $input
                .removeAttr('class')
        ...
        is: {
          ...
          alreadySetup: function() {
            return ($module.is('select') && $module.parent(selector.dropdow).length > 0);
          },
...
$.fn.dropdow.settings.templates = {
  ...
  dropdow: function(select) {
    var
      placeholder = select.placeholder || false,
      values      = select.values || {},
      html        = ''
    ;
    html +=  '<i class="dropdow icon"></i>';
